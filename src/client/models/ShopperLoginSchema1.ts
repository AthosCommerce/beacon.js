 ...
 * 
 * @export
 * @interface ShopperLoginSchema1
 */
export interface ShopperLoginSchema1 {
    /**
     * 
     * @type {Context}
     * @memberof ShopperLoginSchema1
     */
    context?: Context;
}

/**
 * Check if a given object implements the ShopperLoginSchema1 interface.
 */
export function instanceOfShopperLoginSchema1(value: object): value is ShopperLoginSchema1 {
    return true;
}

export function ShopperLoginSchema1FromJSON(json: any): ShopperLoginSchema1 {
    return ShopperLoginSchema1FromJSONTyped(json, false);
}

export function ShopperLoginSchema1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ShopperLoginSchema1 {
    if (json == null) {
        return json;
    }
    return {
  ...
  export function ShopperLoginSchema1ToJSON(json: any): ShopperLoginSchema1 {
      return ShopperLoginSchema1ToJSONTyped(json, false);
  }

  export function ShopperLoginSchema1ToJSONTyped(value?: ShopperLoginSchema1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
