...
import type { OrderTransactionSchema1Data } from './OrderTransactionSchema1Data';
import {
    OrderTransactionSchema1DataFromJSON,
    OrderTransactionSchema1DataFromJSONTyped,
    OrderTransactionSchema1DataToJSON,
    OrderTransactionSchema1DataToJSONTyped,
} from './OrderTransactionSchema1Data';

/**
 * 
 * @export
 * @interface OrderTransactionSchema1
 */
export interface OrderTransactionSchema1 {
    /**
     * 
     * @type {Context}
     * @memberof OrderTransactionSchema1
     */
    context?: Context;
    /**
     * 
     * @type {OrderTransactionSchema1Data}
     * @memberof OrderTransactionSchema1
     */
    data?: OrderTransactionSchema1Data;
}

/**
 * Check if a given object implements the OrderTransactionSchema1 interface.
 */
export function instanceOfOrderTransactionSchema1(value: object): value is OrderTransactionSchema1 {
    return true;
}

export function OrderTransactionSchema1FromJSON(json: any): OrderTransactionSchema1 {
    return OrderTransactionSchema1FromJSONTyped(json, false);
}

export function OrderTransactionSchema1FromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderTransactionSchema1 {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : OrderTransactionSchema1DataFromJSON(json['data']),
    };
}

  export function OrderTransactionSchema1ToJSON(json: any): OrderTransactionSchema1 {
      return OrderTransactionSchema1ToJSONTyped(json, false);
  }

  export function OrderTransactionSchema1ToJSONTyped(value?: OrderTransactionSchema1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': OrderTransactionSchema1DataToJSON(value['data']),
    };
}
