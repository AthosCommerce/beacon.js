 ...
 * Event details
 * @export
 * @interface OrderTransactionSchema1Data
 */
export interface OrderTransactionSchema1Data {
    /**
     * Unique order ID
     * @type {string}
     * @memberof OrderTransactionSchema1Data
     */
    orderId?: string;
    /**
...
/**
 * Check if a given object implements the OrderTransactionSchema1Data interface.
 */
export function instanceOfOrderTransactionSchema1Data(value: object): value is OrderTransactionSchema1Data {
    return true;
}

export function OrderTransactionSchema1DataFromJSON(json: any): OrderTransactionSchema1Data {
    return OrderTransactionSchema1DataFromJSONTyped(json, false);
}

export function OrderTransactionSchema1DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): OrderTransactionSchema1Data {
    if (json == null) {
        return json;
    }
    return {
        ...
        'transactionTotal': json['transactionTotal'] == null ? undefined : json['transactionTotal'],
  ...
  export function OrderTransactionSchema1DataToJSON(json: any): OrderTransactionSchema1Data {
      return OrderTransactionSchema1DataToJSONTyped(json, false);
  }

  export function OrderTransactionSchema1DataToJSONTyped(value?: OrderTransactionSchema1Data | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
