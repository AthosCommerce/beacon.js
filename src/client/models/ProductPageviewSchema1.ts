...
import type { ProductPageviewSchema1Data } from './ProductPageviewSchema1Data';
import {
    ProductPageviewSchema1DataFromJSON,
    ProductPageviewSchema1DataFromJSONTyped,
    ProductPageviewSchema1DataToJSON,
    ProductPageviewSchema1DataToJSONTyped,
} from './ProductPageviewSchema1Data';

/**
 * 
 * @export
 * @interface ProductPageviewSchema1
 */
export interface ProductPageviewSchema1 {
    /**
     * 
     * @type {Context}
     * @memberof ProductPageviewSchema1
     */
    context?: Context;
    /**
     * 
     * @type {ProductPageviewSchema1Data}
     * @memberof ProductPageviewSchema1
     */
    data?: ProductPageviewSchema1Data;
}

/**
 * Check if a given object implements the ProductPageviewSchema1 interface.
 */
export function instanceOfProductPageviewSchema1(value: object): value is ProductPageviewSchema1 {
    return true;
}

export function ProductPageviewSchema1FromJSON(json: any): ProductPageviewSchema1 {
    return ProductPageviewSchema1FromJSONTyped(json, false);
}

export function ProductPageviewSchema1FromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductPageviewSchema1 {
    if (json == null) {
        return json;
    }
    return {
        ...
        'data': json['data'] == null ? undefined : ProductPageviewSchema1DataFromJSON(json['data']),
    };
}

  export function ProductPageviewSchema1ToJSON(json: any): ProductPageviewSchema1 {
      return ProductPageviewSchema1ToJSONTyped(json, false);
  }

  export function ProductPageviewSchema1ToJSONTyped(value?: ProductPageviewSchema1 | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'data': ProductPageviewSchema1DataToJSON(value['data']),
    };
}
