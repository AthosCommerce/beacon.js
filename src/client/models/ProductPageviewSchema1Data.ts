 ...
 * Event details
 * @export
 * @interface ProductPageviewSchema1Data
 */
export interface ProductPageviewSchema1Data {
    /**
     * 
     * @type {Item}
     * @memberof ProductPageviewSchema1Data
     */
    result?: Item;
}

/**
 * Check if a given object implements the ProductPageviewSchema1Data interface.
 */
export function instanceOfProductPageviewSchema1Data(value: object): value is ProductPageviewSchema1Data {
    return true;
}

export function ProductPageviewSchema1DataFromJSON(json: any): ProductPageviewSchema1Data {
    return ProductPageviewSchema1DataFromJSONTyped(json, false);
}

export function ProductPageviewSchema1DataFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductPageviewSchema1Data {
    if (json == null) {
        return json;
    }
    return {
        
        'result': json['result'] == null ? undefined : ItemFromJSON(json['result']),
    };
}

  export function ProductPageviewSchema1DataToJSON(json: any): ProductPageviewSchema1Data {
      return ProductPageviewSchema1DataToJSONTyped(json, false);
  }

  export function ProductPageviewSchema1DataToJSONTyped(value?: ProductPageviewSchema1Data | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
